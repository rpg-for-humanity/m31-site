  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center text-center text-white px-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-bold mb-3 tracking-tight text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
          RPG for Human
        ...
        <p className="text-2xl md:text-3xl text-cyan-400 font-semibold mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
          Learn by unlocking, not drilling.
        </p>

        <p className="text-lg md:text-xl text-white mb-2 leading-relaxed max-w-2xl mx-auto font-medium drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
          Every NPC knows something you need. Start by listening. Level up to speaking. Complete the mission.
        </p>

        <p className="text-base md:text-lg text-white/80 mb-6 leading-relaxed max-w-2xl mx-auto drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
        ...
        <div className="border-t border-white/20 pt-6 max-w-xl mx-auto">
          <p className="text-lg md:text-xl text-white font-semibold mb-2 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
          ...
          <p className="text-lg text-cyan-400 font-semibold mt-3 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
